...
DummyClientSession::DummyClientSession() : Session(CLIENT_BUFSIZE, CLIENT_BUFSIZE), mPlayer(std::make_shared<Player>(this))
{
}
...
void DummyClientSession::ConnectCompletion()
{
	...
	mPlayer->DoSync(&Player::RequestLogin);
}
...
void DummyClientSession::OnDisconnect(DisconnectReason dr)
{
